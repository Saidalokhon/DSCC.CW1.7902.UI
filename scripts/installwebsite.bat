...
IF EXIST c:\DSCC.CW1.7902.UI\scripts\installwebsite.ps1 %SystemRoot%\sysnative\WindowsPowerShell\v1.0\powershell.exe -command "c:\DSCC.CW1.7902.UI\scripts\installwebsite.ps1"